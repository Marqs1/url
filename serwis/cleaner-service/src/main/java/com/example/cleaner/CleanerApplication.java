...
@SpringBootApplication(scanBasePackages = {"com.example.common", "com.example.cleaner"})
...
// File: cleaner-service/src/main/java/com/example/cleaner/UrlCleaner.java
package com.example.cleaner;
...
public class UrlCleaner {
    ...
    public void cleanOldUrls() {
        ...
        while (iterator.hasNext()) {
            ...
            Instant expiry = mapping.getCreatedAt().plusSeconds((long) mapping.getTtlDays() * 86400);
